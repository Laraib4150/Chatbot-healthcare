...
# Utility function to destroy packed widgets
...
def register():
    global register_screen, username, password, username_entry, password_entry
    
    destroyPackWidget(main_screen)
...
def register_user():
    ...
    Button(register_screen, text="Click Here to proceed", command=btnSuccess_Click).pack()
